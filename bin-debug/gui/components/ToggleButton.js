...
(function (ST) {
    var ToggleButton = (function (_super) {
         ...
         * 具体按钮类构造函数
         */
        function ToggleButton(defaultSkin, pressSkin, selectSkin, disableSkin, showYoyo) {
        ...
        // *****************************************        初始化绘制        *********************
        ToggleButton.prototype.touchBeginHandler = function (e) {
            if (!this._isSelect) {
        ...
        ToggleButton.prototype.removedFromStageHandler = function (e) {
            this.destroy();
        };
        ToggleButton.prototype.addedToStageHandler = function (e) {
        ...
        ToggleButton.prototype.setSelect = function (b) {
            if (!b) {
                this._defaultSpr.visible = true;
                this._pressSpr.visible = false;
                this._selectSpr.visible = false;
         ...
         * @param	b
         */
        ToggleButton.prototype.setDisable = function (b) {
            if (!b) {
        ...
        ToggleButton.prototype.setPostion = function (x, y) {
            this.x = x + this._offX;
            this.y = y + this._offY;
        };
    ...
    ST.ToggleButton = ToggleButton;
    __reflect(ToggleButton.prototype, "ST.ToggleButton");
})(ST || (ST = {}));
