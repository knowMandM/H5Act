...
module ST {
    ...
    export class BubbleBox extends egret.DisplayObjectContainer{
        ...
        private closePanelHandler(e:egret.TimerEvent):void
        {
            ...
            {
                tw.to({alpha:0},ConfigInfo.ALPHA_OUT_SPEED).call(() =>{
            ...
            {
                tw.to({alpha:0,y:this.y-100},ConfigInfo.ALPHA_OUT_SPEED).call(() =>{
                        DisplayObjectUtil.removeAllChild(this);
                        DisplayObjectUtil.removeForParent(this);
                    }
                );
            ...
            {
                tw.to({x:0-this.width},ConfigInfo.ALPHA_OUT_SPEED*15).call(() =>{
                        DisplayObjectUtil.removeAllChild(this);
                        DisplayObjectUtil.removeForParent(this);
                        this.dispatchEventWith("removed")
                    }
                );
            }
        }
