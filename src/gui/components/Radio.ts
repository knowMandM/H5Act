...
module ST {
    ...
    export class Radio extends egret.DisplayObjectContainer {
        public data: Object;
         ...
         * selectSkin - 选择后状态
         */
        public constructor(defaultSkin: string, pressSkin: string, selectSkin: string, disableSkin?: string, showYoyo?: boolean, value?: string) {
            super();
