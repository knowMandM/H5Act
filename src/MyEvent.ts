...
{
    public static INITSCENE:string = "init_scene";
    public static GETREWARD1:string = "get_reward1";
    public static GETREWARD2:string = "get_reward2";
    public static REFRESHREWARDRET1:string = "refresh_reward_ret1";
    public static REFRESHREWARDRET2:string = "refresh_reward_ret2";
    public static REFRESHFINAL:string = "refresh_final_reward";
    public static GETFINALREWARD:string = "get_final_reward";
    public static ACTNOTOPEN:string = "act_not_open";
    public static ACTEND:string = "act_end";
    public static INITLOADING:string = "init_loading";
